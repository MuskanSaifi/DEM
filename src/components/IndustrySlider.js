...
const IndustrySlider = () => {
  ...
  useEffect(() => {
    // ⭐ FIX 1: Tell Next.js we are running on client
    setIsClient(true);
        ...
        >
          {categories.map((category) => (
            <SwiperSlide key={category._id}>
              <div className="bg-white rounded-2xl hover:scale-[1.02] transition-all duration-300 p-4 shadow-md hover:shadow-xl mb-4">
